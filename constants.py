...
#Maple Leaf  (credit Paul Bourke)
constants["maple"]=[
    [na([[0.14,0.01],[0.0,0.51]]),na([0-0.08,0-1.31]),0,1/4],
    [na([[0.43,0.52],[0-0.45,0.5]]),na([1.49,0-0.75]),0,1/4],
    [na([[0.45,0-0.49],[0.47,0.47]]),na([0-1.62,0-0.74]),0,1/4],
    [na([[0.49,0.0],[0.0,0.51]]),na([0.02,1.62]),0,1/4],
